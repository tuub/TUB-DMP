...
@section('body')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                {!! Form::model($question, ['method' => 'PUT', 'route' => ['admin.question.update', $question->id], 'class' => '', 'role' => 'form']) !!}
                    <div class="form-group row container">
                        <div class="col-md-2">
                            {!! Form::Label( 'keynumber', 'Keynumber' ) !!}
                        </div>
                        <div class="col-md-10">
                            {!! Form::Text( 'keynumber', $question->keynumber, array('class' => 'form-control xs') ) !!}
                    ...
                    <div class="form-group row container">
                        ...
                        <div class="col-md-10">
                            {!! Form::Text( 'order', $question->order, array('class' => 'form-control xs') ) !!}
                    ...
                    <div class="form-group row container">
                        ...
                        <div class="col-md-10">
                            {!! Form::Textarea( 'text', $question->text, array('class' => 'form-control') ) !!}
                    ...
                    <div class="form-group row container">
                        ...
                        <div class="col-md-10">
                            {!! Form::Textarea( 'output_text', $question->output_text, array('class' => 'form-control') ) !!}
                    ...
                    <div class="form-group row container">
                        ...
                        <div class="col-md-10">
                            {!! Form::select('template_id', [null => 'None'] + $templates->toArray(), $question->template_id, array('class' => 'form-control')) !!}
                    ...
                    <div class="form-group row container">
                        ...
                        <div class="col-md-10">
                            {!! Form::select('section_id', [null => 'None'] + $sections->toArray(), $question->section_id, array('class' => 'form-control')) !!}
                    ...
                    <div class="form-group row container">
                        ...
                        <div class="col-md-10">
                            {!! Form::Text( 'prepend', $question->prepend, array('class' => 'form-control') ) !!}
                    ...
                    <div class="form-group row container">
                        ...
                        <div class="col-md-10">
                            {!! Form::Text( 'append', $question->append, array('class' => 'form-control') ) !!}
                    ...
                    <div class="form-group row container">
                        ...
                        <div class="col-md-10">
                            {!! Form::Text( 'comment', $question->comment, array('class' => 'form-control') ) !!}
                    ...
                    <div class="form-group row container">
                        ...
                        <div class="col-md-10">
                            {!! Form::Text( 'reference', $question->reference, array('class' => 'form-control') ) !!}
                    ...
                    <div class="form-group row container">
                        ...
                        <div class="col-md-10">
                            @if( strlen( $question->guidance ) > 75 )
                                {!! Form::Textarea( 'guidance', $question->guidance, array('class' => 'form-control') ) !!}
                            @else
                                {!! Form::Text( 'guidance', $question->guidance, array('class' => 'form-control') ) !!}
                            @endif
                    ...
                    <div class="form-group row container">
                        ...
                        <div class="col-md-10">
                            {!! Form::Textarea( 'hint', $question->hint, array('class' => 'form-control') ) !!}
                    ...
                    <div class="form-group row container">
                        ...
                        <div class="col-md-10">
                            {!! Form::radio('is_mandatory', 1, $question->is_mandatory) !!} Yes
                            {!! Form::radio('is_mandatory', 0, $question->is_mandatory) !!} No
                    ...
                    <div class="form-group row container">
                        ...
                        <div class="col-md-10">
                            {!! Form::radio('is_active', 1, $question->is_active) !!} Yes
                            {!! Form::radio('is_active', 0, $question->is_active) !!} No
                    ...
                    <div class="form-group row container">
                        ...
                        <div class="col-md-10">
                            {!! Form::radio('read_only', 1, $question->read_only) !!} Yes
                            {!! Form::radio('read_only', 0, $question->read_only) !!} No
