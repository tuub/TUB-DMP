...
@section('body')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                {!! Form::model($project, ['method' => 'PUT', 'route' => ['admin.project.update', $project->id], 'class' => '', 'role' => 'form']) !!}
                ...
                <div class="form-group row container">
                    ...
                    <div class="col-md-10">
                        {!! Form::Text( 'contact_email', $project->contact_email, array('class' => 'form-control') ) !!}
